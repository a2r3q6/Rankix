...
public class Main {
    ...
    private static final String REMOTE_SOCKET = "ws://theapache64.xyz:8080/rankix/RankixSocket";
                ...
                .addListener(new WebSocketAdapter() {
                    public void onTextMessage(WebSocket websocket, String jsonData) {
                        try {
                            ...
                            if (hasError) {
                                System.out.println("RankixSocket -> " + jData.getString(MESSAGE));
                            } else {
                            ...
                            e.printStackTrace();
                            System.out.println("Error: " + e.getMessage() + " : message : " + jsonData);
                        }
