...
public class Connection {
    ...
    public static java.sql.Connection getConnection() {
        ...
        try {
            ...
            DataSource ds = (DataSource) envContext.lookup(debugMode ? "jdbc/shifar" : "jdbc/MySQLDS");
    ...
    //Local credentials
    private static final String LC_HOST = "192.168.0.105";
    ...
    private static final String DATABASE_NAME = "shifar";
